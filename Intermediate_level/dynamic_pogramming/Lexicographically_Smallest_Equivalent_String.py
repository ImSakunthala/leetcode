...
the smallest equivalent string of baseStr.

Return lexicographically the  smallest equivalent string of baseStr by using the equivalency information from s1 and s2.
...
class Solution:
       def mapping_characters_within_pair(self, string_1: str, string_2: str) -> list:
          pairs = list(zip(string_1, string_2))
...
solution = Solution()
print(solution.mapping_characters_within_pair('leetcode', 'programs'))
