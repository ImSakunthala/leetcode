...
class Solution:
    def sortSentence(self, s: str) -> str:
        ...
        sort_sentence = [''] * len(list_of_words)

        for word in list_of_words:
            remove_int = int(word[-1])
            sort_sentence[remove_int-1] = word[:-1]

        return ' '.join(sort_sentence)


solution = Solution()
print('This is a sentence->', solution.sortSentence(s = 'is2 sentence4 This1 a3'))
print('"Me Myself and I"->', solution.sortSentence(s = "Myself2 Me1 I4 and3"))
