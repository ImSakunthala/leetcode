...
solution = Solution()
print('[24,21]->', solution.fairCandySwap(aliceSizes = [35,17,4,24,10], bobSizes = [63,21]))
print('[5,4]->', solution.fairCandySwap(aliceSizes = [1,2,5], bobSizes = [2,4]))
print('[1,2]->', solution.fairCandySwap(aliceSizes = [1,1], bobSizes = [2,2]))
print('[1,2]->', solution.fairCandySwap(aliceSizes = [1,2], bobSizes = [2,3]))
print('[2,3]->', solution.fairCandySwap(aliceSizes = [2], bobSizes = [1,3]))
